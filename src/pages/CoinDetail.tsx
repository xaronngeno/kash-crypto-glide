        ...
        <div className="mb-4">
          ...
          <KashCard className="p-4">
            {coinSymbol === 'SOL' ? (
              ...
              <p className="text-gray-500 text-center py-2">No description available.</p>
            )}
          </KashCard>
        </div>
          ...
          <KashCard className="overflow-hidden">
            <div className="divide-y">
              ...
              <div className="flex justify-between p-4">
                ...
                <span className="font-medium">
                  ${((coinData.marketCap || coinData.price * 1000000) / 1000000000).toLocaleString(undefined, {maximumFractionDigits: 2})}B
                </span>
              </div>
              ...
              {coinSymbol === 'SOL' && (
                <>
                  <div className="flex justify-between p-4">
                    ...
                    <span className="font-medium">598.13M</span>
                  </div>
                  <div className="flex justify-between p-4">
                    <span className="text-gray-500">Circulating Supply</span>
                    <span className="font-medium">515.59M</span>
                  </div>
                </>
              )}
            </div>
