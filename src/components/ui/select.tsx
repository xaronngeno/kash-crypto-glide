...
>(({ className, children, variant = "default", ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      variant === "dark" ? "bg-gray-800 text-white border-gray-700" : "bg-background",
      className
    )}
    {...props}
  >
...
>(({ className, children, variant = "default", ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      variant === "dark" ? "hover:bg-gray-700 focus:bg-gray-700" : "hover:bg-accent",
      className
    )}
    {...props}
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <Check className={cn("h-4 w-4", variant === "dark" ? "text-white" : "")} />
      </SelectPrimitive.ItemIndicator>
    </span>
