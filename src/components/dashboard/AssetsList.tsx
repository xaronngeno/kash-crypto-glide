  ...
  return (
    <div className="space-y-6">
      {sortedBlockchains.map(blockchain => (
        <div key={blockchain} className="space-y-3">
          <h3 className="text-sm font-medium text-gray-500 flex items-center">
            {blockchain}
            {blockchain === 'Ethereum' && <span className="bg-blue-100 text-blue-800 text-xs px-2 py-0.5 rounded ml-2">ERC-20</span>}
            {blockchain === 'Solana' && <span className="bg-purple-100 text-purple-800 text-xs px-2 py-0.5 rounded ml-2">SPL</span>}
          </h3>
          
          {groupedAssets[blockchain].map((asset) => (
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <div className="flex items-center gap-1">
                      ...
                      {asset.walletType === 'token' && (
                        <span className="text-xs bg-green-100 text-green-800 px-1.5 py-0.5 rounded">Token</span>
                      )}
                    </div>
